...
var searchSources = [
  ["x",        "https://www.searx.be/search?q={Q}",                                "Searx"],
  ["y",        "https://www.youtube.com/results?search_query={Q}",               "YouTube"],
  ["t",        "https://nyaa.si/?f=0&c=0_0&q={Q}",                                  "Nyaa"],
  ["i",        "https://www.searx.be/search?{Q}&cataogies=images",          "Searx Images"],
  ["w",        "https://wikiless.org/w/index.php?search={Q}",                   "Wikiless"],
  ["p",        "https://www.protondb.com/search?q={}Q",                         "ProtonDB"]
];
...
var linkMenu = [  
  ...
  ["/g/ - Technology",           "http://boards.4channel.org/g/", ""],
  ["/lgbt/ - LGBT",           "http://boards.4channel.org/lgbt/", ""],

  [svgSocial,                  "red",                                         "-HEAD-"], // Social
  ["libreddit",                "https://lr.mint.lgbt/",                          ""],
  ["piped",                    "http://piped.mint.lgbt",         ""],
  ["nitter",                   "https://nittir.mint.lgbt",                    ""],
  ["Messenger",                "https://www.messenger.com/",                        ""],
  ["Whatsapp",                 "https://web.whatsapp.com/",                         ""],

  [svgGamepad,                 "red",                                                     "-HEAD-"], // Games
  ["ProtonDB",                 "https://www.protondb.com/",                                     ""],
  ["SteamDB",                  "https://https://steamdb.info/",                                 ""],
  ["/tekgen/ Doc",             "http://steampowered.com/",                                      ""],
  ["Monkey Type",              "https://monkeytype.com/",                                       ""],
  
  
  [svgTrash,                   "red",                                                 "-HEAD-"], // Anime
  ["1337x",                     "http://www.1337x.to", ""],
  ["torrentGalaxy",             "http://torrentgalaxy.to", ""],
  ["Nyaa",                      "http://www.nyaa.si", ""],

  [svgCode,                    "red",                                 "-HEAD-"], // Work
  ["Email",                    "https://mail.google.com",               ""],
  ["Guerilla Mail",            "https://www.guerrillamail.com/",        ""],
  ["century tech",             "https://app.century.tech",              ""],
